...
const UnderlyingToken = artifacts.require('liqudityMining/LgmUnderlyingToken.sol');
const GovernanceToken = artifacts.require('liqudityMining/LgmGovernanceToken.sol');
const LiquidityPool = artifacts.require('liqudityMining/LgmLiquidityPool.sol');
...
contract('liquidityPool', accounts => {
  ...
  beforeEach(async () => {
    underlyingToken = await UnderlyingToken.new('token1', 'tk1');
    governanceToken = await GovernanceToken.new('gov token', 'GTK');
